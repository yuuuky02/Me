...
//                    int size = (int) (bitmap.getHeight() * (300.0 / bitmap.getWidth()));
                    scaled = Bitmap.createScaledBitmap(bitmap, 100, 100, true);
                    scaled1 = Bitmap.createScaledBitmap(bitmap, 70, 70, true);
//                    iv3.setImageURI(albumUri);
                    iv3.setImageBitmap(scaled);
                } catch (IOException e) {
                    e.printStackTrace();
                }
        }
